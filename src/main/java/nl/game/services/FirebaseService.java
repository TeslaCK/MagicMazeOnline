...
public class FirebaseService implements DataService{
	 ...
	 */
	public void oldset(String documentId, Map<String, Object> docData) {
	...
	public void set(String pathToCollection, String documentId, Object docData) {
		CollectionReference colRef = this.firestore.collection(pathToCollection);
		// this.ref stond hieronder, de line hierboven zelf gemaakt
