...
import nl.game.models.PlayerModel;
...
public class App 
{
	...
	public App() {
		...
		fbService.oldset(gameIdentifier, dataForFirebase);			// Game-gegevens opslaan.

		fbService.set("games/game1/game1", "player1", playerModel);
