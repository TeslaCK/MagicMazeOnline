...
public class LobbyModel implements Observable, Model {
	...
	public boolean confirmationToStart = false;
	public int confirmationTeller;
	public String state;
	...
	public String whatIsTheHighestLobbyId() throws InterruptedException, ExecutionException {
		CollectionReference collectionRef = FirebaseService.firestore.collection("newlobbies");
	...
	public int getConfirmationTeller() {
		return confirmationTeller;
	}


	public void setConfirmationTeller(int confirmationTeller) {
		this.confirmationTeller = confirmationTeller;
	}
